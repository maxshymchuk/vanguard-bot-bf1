...
discord_kick_webhook_url = None
kick_webhook = SyncWebhook.from_url(discord_kick_webhook_url) if discord_kick_webhook_url else None
discord_monitoring_webhook_url = None
monitoring_webhook = SyncWebhook.from_url(discord_monitoring_webhook_url) if discord_monitoring_webhook_url else None
